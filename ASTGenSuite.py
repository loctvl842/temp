...
#         input = r"""class test {} class test1 {}"""
#         expect = str(Program([ClassDecl(Id("test"), []), ClassDecl(Id("test1"), [])]))
#         self.assertTrue(TestAST.test(input, expect, 302))

#     def test_3(self):
#         """test extend"""
#         input = r"""class test extends loc {}"""
#         expect = str(Program([ClassDecl(Id("test"), [], Id("loc"))]))
#         self.assertTrue(TestAST.test(input, expect, 303))

#     def test_4(self):
#         """test mutable attribute declaration"""
#         input = r"""
# class test extends loc {
#     int a;
# }"""
#         expect = str(
#             Program(
...
#     def test_5(self):
#         """test multiple attributes declaration"""
#         input = r"""
# class test extends loc {
#     int a, b;
# }"""
...
#                             AttributeDecl(Instance(), VarDecl(Id("d"), FloatType())),
#                             AttributeDecl(Instance(), VarDecl(Id("e"), FloatType())),
#                         ],
#                         Id("loc"),
#                     )
#                 ]
...
#     def test_7(self):
#         """test multiple static attributes declaration"""
#         input = r"""
# class test extends loc {
#     static int a, b, c;
#     float d, e;
...
#                             AttributeDecl(Static(), VarDecl(Id("c"), IntType())),
#                             AttributeDecl(Instance(), VarDecl(Id("d"), FloatType())),
#                             AttributeDecl(Instance(), VarDecl(Id("e"), FloatType())),
#                         ],
#                         Id("loc"),
...
#     def test_8(self):
#         """test attribute declaration with init"""
#         input = r"""
# class test extends loc {
#     static int a = 2, b, c;
#     float d, e;
...
#                         [
#                             AttributeDecl(
#                                 Static(), VarDecl(Id("a"), IntType(), IntLiteral(2))
#                             ),
#                             AttributeDecl(Static(), VarDecl(Id("b"), IntType())),
#                             AttributeDecl(Static(), VarDecl(Id("c"), IntType())),
#                             AttributeDecl(Instance(), VarDecl(Id("d"), FloatType())),
...
#     def test_9(self):
#         """test binary additive expression"""
#         input = r"""
# class test extends loc {
#     static int a = 2 + 3, b, c;
#     float d, e;
# }"""
#         expect = str(
#             Program(
...
#     def test_10(self):
#         """test binary additive expression with multiplicative expression"""
#         input = r"""
# class test extends loc {
#     static int a = 2 + 3 * 4, b, c;
#     float d, e;
# }"""
#         expect = str(
#             Program(
...
#                                         "+",
#                                         BinaryOp(
#                                             "+", FloatLiteral(2.3), FloatLiteral(4.5)
#                                         ),
#                                         FloatLiteral(6.7),
#                                     ),
#                                 ),
...
#                                     StringType(),
#                                     BinaryOp(
#                                         "^", StringLiteral("loc"), StringLiteral("van")
#                                     ),
#                                 ),
#                             ),
#                         ],
...
#                         [
#                             AttributeDecl(
#                                 Instance(), ConstDecl(Id("x"), IntType(), IntLiteral(5))
#                             ),
#                             AttributeDecl(
#                                 Instance(),
#                                 ConstDecl(Id("a"), IntType(), IntLiteral(66)),
#                             ),
#                             AttributeDecl(
#                                 Instance(), ConstDecl(Id("b"), IntType(), IntLiteral(6))
#                             ),
#                             AttributeDecl(
#                                 Instance(),
#                                 ConstDecl(Id("h"), FloatType(), IntLiteral(1)),
#                             ),
#                             AttributeDecl(
#                                 Instance(),
#                                 ConstDecl(Id("k"), FloatType(), IntLiteral(2)),
#                             ),
#                         ],
#                     )
#                 ]
...
#                             AttributeDecl(Instance(), VarDecl(Id("a"), IntType())),
#                             AttributeDecl(
#                                 Instance(), VarDecl(Id("b"), IntType(), IntLiteral(6))
#                             ),
#                             AttributeDecl(
#                                 Instance(),
#                                 VarDecl(Id("h"), FloatType(), FloatLiteral(1.3)),
#                             ),
#                             AttributeDecl(
#                                 Instance(),
#                                 VarDecl(Id("k"), FloatType(), FloatLiteral(2.4)),
#                             ),
#                         ],
#                     )
#                 ]
...
#                             ),
#                             AttributeDecl(
#                                 Instance(), VarDecl(Id("x"), ArrayType(4, FloatType()))
#                             ),
#                             AttributeDecl(
#                                 Instance(), VarDecl(Id("y"), ArrayType(4, FloatType()))
#                             ),
#                         ],
#                     )
#                 ]
...
#                                     Id("c"),
#                                     IntType(),
#                                     BinaryOp("!=", Id("daaaaaa"), IntLiteral(5)),
#                                 ),
#                             ),
#                             AttributeDecl(Instance(), VarDecl(Id("cacbu"), IntType())),
#                             MethodDecl(
#                                 Instance(),
#                                 Id("kori"),
#                                 [],
...
#                                         Assign(
#                                             Id("b"),
#                                             FieldAccess(SelfLiteral(), Id("suck")),
#                                         )
#                                     ],
#                                 ),
#                             ),
...
#             }"""
#         expect = "Program([ClassDecl(Id(test),[AttributeDecl(Instance,VarDecl(Id(nah),ClassType(Id(Shape)))),MethodDecl(Id(<init>),Instance,[],Block([VarDecl(Id(s),ClassType(Id(Shape))),VarDecl(Id(x),IntType),VarDecl(Id(y),FloatType)],[]))])])"
...
#             int x;
#         }"""
#         expect = """Program([ClassDecl(Id(Phuong),[AttributeDecl(Instance,VarDecl(Id(x),IntType))])])"""
...
#         }
#         """
#         expect = """Program([ClassDecl(Id(Shape),[MethodDecl(Id(<init>),Instance,[],Block([VarDecl(Id(width),IntType),VarDecl(Id(height),IntType),VarDecl(Id(pi),FloatType,FloatLit(3.14))],[]))])])"""
...
#         }
#         """
#         expect = """Program([ClassDecl(Id(Shape),[MethodDecl(Id(<init>),Instance,[],Block([VarDecl(Id(x),IntType),VarDecl(Id(y),IntType,IntLit(10)),VarDecl(Id(z),ClassType(Id(Shape)))],[])),MethodDecl(Id(main),Static,[],VoidType,Block([VarDecl(Id(e),ClassType(Id(Shape)),NewExpr(Id(Shape),[]))],[]))])])"""
...
#             void main()
#             {
#                 int[5] Kori = {true, true, false};
#                 Kori[5] := 7;
#                 this.print(Kori, 0, 4);
#             }
#         }"""
#         expect = "Program([ClassDecl(Id(test),[MethodDecl(Id(main),Static,[],VoidType,Block([VarDecl(Id(Kori),ArrayType(5,IntType),[BooleanLit(True),BooleanLit(True),BooleanLit(False)])],[AssignStmt(ArrayCell(Id(Kori),IntLit(5)),IntLit(7)),Call(Self(),Id(print),[Id(Kori),IntLit(0),IntLit(4)])]))])])"
...
#     def test_82(self):
#         input = """class loc extends ABC{}"""
#         expect = """Program([ClassDecl(Id(loc),Id(ABC),[])])"""
...
#                         }
#                     }"""
#         expect = "Program([ClassDecl(Id(test),[MethodDecl(Id(main),Static,[],VoidType,Block([],[AssignStmt(FieldAccess(Self(),Id(aPI)),FloatLit(3.14)),AssignStmt(Id(value),CallExpr(Id(x),Id(foo),[IntLit(5)])),AssignStmt(ArrayCell(Id(l),IntLit(3)),BinaryOp(*,Id(value),IntLit(2)))]))])])"
